				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" id="sample6_postcode"
							placeholder="우편번호" style="margin-right: 10px;" name="zipCode">
						</td>
					...
					<tr>
						...
						<td><label class="test_obj"> <input type="radio"
								name="gender" value="apple"> <span>남자</span>
						</label> <label class="test_obj"> <input type="radio"
								name="gender" value="banana"> <span>여자</span>
						</label></td>
					</tr>
					<tr>
								...
								<c:forEach var="list" items="${sessionScope.basket}">
									...
									<tr class="basket">
										<td><input type="checkbox" name="1"
											data-product-id="${list.prod_seq}"></td>
										<td>
											<article>
	...
	<script>
		...
		function deleteSelected() {
			...
			for (var i = 0; i < checkboxes.length; i++) {
				...
				checkedProducts.push(checkboxes[i]
			...
			if (checkedProducts.length > 0) {
				$.ajax({
					...
					data : {
						"checkedProductsString" : checkedProductsString
					},
