            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><label class="test_obj"> <input type="radio"
                         value="M" name="gender"> <span>남자</span>
                  </label> <label class="test_obj"> <input type="radio" 
                        value="W" name="gender"> <span>여자</span>
                  </label></td>
               </tr>
               <tr>
...
<!-- ★★ -->
   <div id="categori">
      <ul>
         <li><a href="goLighting.do"><img src="img/logo/LIGHT.png" alt="카테고리 사진"></a></li>
...
<!-- ★★ -->
   ...
   <div class="products">
      <a href="goProduct.do?prod_seq=0"> <img src="images/sunglasses.jpg">
         <p>Sunglasses</p>
