			...
			<div class="wrap">
				...
				<div id="content_wrap">
						...
						<form action="#" method="post">
							<table id="join">
								<tbody>
									<tr>
										<td>ID</td>
										<td><input type="text" readonly="사용자 아이디"
											placeholder="사용자 아이디"></td>
										<td></td>
									</tr>
									<tr>
										<td>PW</td>
									...
									<tr>
										...
										<td><label class="test_obj"> <input type="radio"
												...
												name="fruit" value="banana"> <span>여자</span>
										</label></td>
									</tr>
									<tr>
					...
					<div id="email_boxes">
						<div class="email-box">
							<p>
								안녕하세요. <strong th:text="${name}">smhrd</strong>님의 결제내역입니다.
							</p>
							<h3>결제 내역</h3>
							<table>
								<tr th:each="orderItem : ${orderItemList}"
									th:with="result=${orderItem.price}">
									<td><span th:text="${orderItem.name}">푹신푹신 쇼파</span></td>
									<td><span
										th:text="${#numbers.formatCurrency(orderItem.price)}">￦9,000</span>원
									</td>
								</tr>
								<tr>
							...
							<p>
								구매일 <span
									th:text="${#dates.format(orderDate, 'yyyy-MM-dd HH:mm:ss')}">2023-08-17
									11:11:11</span>
							</p>
							<p>감사합니다.</p>
						</div>
